                    ...
                    <ul>
                        ...
                        <li class="dropdown language-select dropdown-select-one">
                            ...
                            <ul class="dropdown-menu dropdown-menu-one">
                                <li>
                                    <ul>
                                        <li><a href="{{ route('category.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'a-z' ]) }}" title="A-Z">A-Z {{ __('frontstaticword.Sort') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('category.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'z-a' ]) }}" title="Z-A">Z-A {{ __('frontstaticword.Sort') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('category.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'newest' ]) }}" title="Newest">{{ __('frontstaticword.Newest') }} </a></li>
                                        <br>
                                        <li><a href="{{ route('category.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'featured' ]) }}" title="Featured">{{ __('frontstaticword.Featured') }}</a></li>
                                        
                                        <br>
                                        <li><a href="{{ route('category.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'l-h' ]) }}" title="Featured"> {{ __('frontstaticword.LowtoHigh') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('category.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'h-l' ]) }}" title="Featured"> {{ __('frontstaticword.HightoLow') }}</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown language-select dropdown-select-one">
                            ...
                            <ul class="dropdown-menu dropdown-menu-one">
                                <li>
                                    <ul>
                                        <li><a href="{{ route('subcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'a-z' ]) }}" title="A-Z">A-Z  {{ __('frontstaticword.Sort') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('subcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'z-a' ]) }}" title="Z-A">Z-A {{ __('frontstaticword.Sort') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('subcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'newest' ]) }}" title="Newest"> {{ __('frontstaticword.Newest') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('subcategory.page',['id' => $cats->id, 'category' =>str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'featured' ]) }}" title="Featured">{{ __('frontstaticword.Featured') }}</a></li>

                                        <br>
                                        <li><a href="{{ route('subcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'l-h' ]) }}" title="Featured">{{ __('frontstaticword.LowtoHigh') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('subcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'h-l' ]) }}" title="Featured">{{ __('frontstaticword.HightoLow') }}</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown language-select dropdown-select-one">
                            ...
                            <ul class="dropdown-menu dropdown-menu-one">
                                <li>
                                    <ul>
                                        <li><a href="{{ route('childcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'a-z' ]) }}" title="A-Z">A-Z {{ __('frontstaticword.Sort') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('childcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'z-a' ]) }}" title="Z-A">Z-A {{ __('frontstaticword.Sort') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('childcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'newest' ]) }}" title="Newest"> {{ __('frontstaticword.Newest') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('childcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'featured' ]) }}" title="Featured">{{ __('frontstaticword.Featured') }}</a></li>

                                        <br>
                                        <li><a href="{{ route('childcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'l-h' ]) }}" title="Featured">{{ __('frontstaticword.LowtoHigh') }}</a></li>
                                        <br>
                                        <li><a href="{{ route('childcategory.page',['id' => $cats->id, 'category' => str_slug(str_replace('-','&',$cats->title)), 'sortby' => 'h-l' ]) }}" title="Featured">{{ __('frontstaticword.HightoLow') }}</a></li>
