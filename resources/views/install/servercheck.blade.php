  ...
  <body>
    @include('admin.message')
      <div class="preL display-none">
        ...
        <p class="text-center m-3 text-white">&copy;{{ date('Y') }} | Kihlot - Learning Management System | Installer v3.3 | <a class="text-white" href="http://kihlot.com">Kihlot LMS</a></p>
   		</div>
