...
Route::post('/twocheckout', 'TwoCheckoutPaymentController@twocheckout')->name('two.checkout');
Route::get('/twocheckout/callback', 'TwoCheckoutPaymentController@callback');


Route::get('view/verify','TwoFactorAuthController@view')->name('verify.view');
